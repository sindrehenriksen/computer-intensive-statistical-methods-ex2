...
## ---- break
ggsave("../figures/trace.pdf", plot = fig_3a, device = NULL, 
...
## ---- break
ggsave("../figures/acf.pdf", plot = fig_3b, device = NULL, 
       path = NULL, scale = 1, width = 5.5, height = 2*4, 
       units = "in", dpi = 300, limitsize = TRUE)
...
burnin_test_plot
## ---- break
ggsave("../figures/test_burnin.pdf", plot = burnin_test_plot, 
       device = NULL, path = NULL,scale = 1, width = 8, 
       height = 8, units = "in",dpi = 300, limitsize = TRUE)
